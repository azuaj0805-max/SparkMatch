...
const styles = StyleSheet.create({
  ...
  logoM: { fontSize: 44, fontFamily: "DMSans_700Bold", color: '#fff', letterSpacing: -2 },
  ...
  heroTitle: { fontSize: 40, fontFamily: "DMSans_700Bold", color: '#fff', letterSpacing: -1.5 },
  ...
  cardTitle: { fontSize: 22, fontFamily: "DMSans_700Bold", color: Colors.text, letterSpacing: -0.5, marginBottom: 24, lineHeight: 30 },
  ...
  featureTitle: { fontSize: 14, fontFamily: "DMSans_600SemiBold", color: Colors.text, marginBottom: 2 },
  ...
  primaryBtnText: { color: '#fff', fontSize: 16, fontFamily: "DMSans_700Bold", letterSpacing: 0.2 },
