      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.body} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        {step === 0 && (
          <View>
            ...
            <Text style={styles.sub}>This is how you'll appear on your profile.</Text>
        ...
        {step === 1 && (
          <View>
            ...
            <Text style={styles.sub}>The field that sets this app apart.</Text>
            ...
            <Text style={[styles.sectionLabel, { marginTop: Spacing.lg }]}>Salary range</Text>
        ...
        {step === 2 && (
          <View>
            ...
            <Text style={styles.sub}>Helps us show you to the right people.</Text>
        ...
        {step === 5 && (
          <View>
            ...
            <Text style={styles.sub}>Be honest — it helps match you with the right people.</Text>
        ...
        {step === 8 && (
          <View>
            ...
            <Text style={[styles.sectionLabel, { marginTop: Spacing.lg }]}>Minimum salary preference in a partner</Text>
        ...
        {step === 9 && (
          <View>
            ...
            <TextInput style={[styles.input, styles.textarea]} placeholder="Write your answer here..." value={promptAnswer} onChangeText={setPromptAnswer} multiline numberOfLines={4} textAlignVertical="top" />
          </View>
        )}
        {step === 10 && (
          <View style={styles.successWrap}>
            ...
            <Text style={[styles.sub, { textAlign: 'center' }]}>Your profile is live. Start discovering people who match your ambition.</Text>
          </View>
        )}

        <TouchableOpacity style={[GlobalStyles.primaryButton, styles.nextBtn]} onPress={nextStep} disabled={saving} activeOpacity={0.85}>
          {saving ? <ActivityIndicator color="#fff" /> : <Text style={GlobalStyles.primaryButtonText}>{step === TOTAL_STEPS - 1 ? 'Start discovering' : 'Continue'}</Text>}
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  progressWrap: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: Spacing.lg, paddingTop: Spacing.md, paddingBottom: Spacing.sm, gap: Spacing.md },
  backBtn: { padding: 4 },
  backArrow: { fontSize: 20, color: Colors.textSecondary },
  progressTrack: { flex: 1, height: 3, backgroundColor: Colors.surface, borderRadius: 2, overflow: 'hidden' },
  progressFill: { height: '100%', backgroundColor: Colors.primary, borderRadius: 2 },
  body: { padding: Spacing.xl, paddingBottom: 40 },
  stepTag: { fontSize: 11, fontWeight: '600', color: Colors.primary, textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 8 },
  title: { fontSize: 24, fontWeight: '600', color: Colors.text, marginBottom: 6, letterSpacing: -0.3 },
  ...
  sectionLabel: { fontSize: 11, fontWeight: '600', color: Colors.textTertiary, textTransform: 'uppercase', letterSpacing: 0.6, marginBottom: 10 },
